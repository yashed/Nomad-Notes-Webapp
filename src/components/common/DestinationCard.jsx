...
export default function DestinationCard({ imgSrc, title, location, description, link, width  }) {
    ...
    return (
        ...
        <Link to={link || "/"} className={` ${cardWidthClass} p-4 block text-black transition-transform duration-300 ease-in-out transform hover:translate-y-[-5px] hover:backface-visibility-visible`} onDragStart={handleLinkDragStart}>
